from persidict import FileDirDict, S3Dict_Legacy, BasicS3Dict, LocalDict, S3Dict_FileDirCached

mutable_tests = [

(FileDirDict, dict(serialization_format="pkl", digest_len=11))
,(FileDirDict, dict(serialization_format="json", digest_len=11))
,(S3Dict_Legacy, dict(serialization_format="pkl", bucket_name="my_bucket", digest_len=11))
,(S3Dict_Legacy, dict(serialization_format="json", bucket_name="her_bucket", digest_len=11))
...
,(S3Dict_Legacy, dict(serialization_format="pkl", bucket_name="my_bucket", digest_len=5))
,(S3Dict_Legacy, dict(serialization_format="json", bucket_name="his_bucket", digest_len=5))
...
,(S3Dict_Legacy, dict(serialization_format="pkl", bucket_name="my_bucket", digest_len=0))
,(S3Dict_Legacy, dict(serialization_format="json", bucket_name="her_bucket", digest_len=0))
...
,(S3Dict_Legacy, dict(serialization_format="pkl", bucket_name="her_bucket"))
,(S3Dict_Legacy, dict(serialization_format="json", bucket_name="their_bucket"))
...
,(S3Dict_Legacy, dict(serialization_format="pkl", bucket_name="a_bucket", root_prefix ="_"))
,(S3Dict_Legacy, dict(serialization_format="json", bucket_name="the_bucket", root_prefix ="OYO"))
